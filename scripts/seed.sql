...
DELETE FROM images WHERE id = 'img-demo';
DELETE FROM pages WHERE id IN ('winter', 'about', 'demo');

-- Demo image: bytes live in R2 at originals/img-demo (put by the db:seed script).
INSERT INTO images (id, r2_key, width, height, bytes, mime, created_at)
VALUES ('img-demo', 'originals/img-demo', 1200, 800, 3987, 'image/png', 0);
...
INSERT INTO blocks (id, page_id, type, x, y, width, height, z, image_id, text, style, created_at, updated_at) VALUES
  ...
  ('d-i1', 'demo', 'image',      720, 320, 600,  400, 1, 'img-demo', NULL, NULL, 0, 0),
