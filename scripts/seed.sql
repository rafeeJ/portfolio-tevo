...
DELETE FROM blocks WHERE page_id = 'demo';
DELETE FROM pages WHERE id = 'demo';

INSERT INTO pages (id, parent_id, slug, title, sort_order, published, created_at, updated_at)
VALUES ('demo', NULL, 'demo', 'Demo Page', 0, 1, 0, 0);
